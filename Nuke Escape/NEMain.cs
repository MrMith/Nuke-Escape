...
namespace Nuke_Escape
{
	...
	class NEMain : Plugin
	{
		...
		public override void Register()
		{
			...
			AddConfig(new Smod2.Config.ConfigSetting("ne_spawnqueue", "40444", Smod2.Config.SettingType.STRING, true, $"What role spawns first. This repeats so if you had a server limit of 22 there would be 4 scps and 18 dclass."));
		}
	}
}