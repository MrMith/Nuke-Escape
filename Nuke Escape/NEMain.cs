...
namespace Nuke_Escape
{
	...
	class NEMain : Plugin
	{
		...
		public override void Register()
		{
			...
			AddConfig(new Smod2.Config.ConfigSetting("ne_disable", false, true, $"Enables or disables {this.Details.name}."));
			...
			AddConfig(new Smod2.Config.ConfigSetting("ne_spawnqueue", "40444", true, "What role spawns in what order. This repeats so if you had a server limit of 22 there would be 4 scps and 18 dclass."));
			...
			AddConfig(new Smod2.Config.ConfigSetting("ne_latespawn", 15, true, "How long in seconds into the round people who join late will be spawned in."));
